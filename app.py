...
import dash
from dd import DD
load_figure_template(["sandstone", "simplex", "minty_dark"])
...
app = Dash(
    ...
    #external_stylesheets=[dbc.themes.FLATLY, dbc_css],#[dbc.themes.MINTY, dbc.icons.FONT_AWESOME]
    external_stylesheets=[dbc.themes.DARKLY, dbc.icons.FONT_AWESOME],
    suppress_callback_exceptions=True,
)
app.title = '“Data on the rox”: Datenanalyse und Vorhersagen'
...
app.layout = dmc.MantineProvider(
    ...
    children=[navbar, page_container], 
